...
import { renderCalcSteps } from './calc-steps.js';
...
2. 케이스별 세부담 비교 (표 사용, 금액은 천 단위 구분 "1,234,567원" 형식)
   - 비교표 바로 아래에, 함께 제공되는 "### 세금 계산 내역" 블록을 **그대로 삽입**하십시오.
     이 블록은 계산 엔진이 산출한 단계별 내역이므로, 숫자와 계산 단계를 절대 바꾸지 말고
     내용을 그대로 옮기되 필요하면 소제목 수준의 서식만 다듬으십시오.
