...
export function runScenario7(inputs) {
  ...
  return {
    ...
    holdingTax,
    computations: [
      { caseNo: 1, caseLabel: '케이스1 — 일반증여', kind: 'gift', label: '증여세', result: c1GiftResult },
      { caseNo: 1, caseLabel: '케이스1 — 일반증여', kind: 'acq', label: '취득세', result: c1AcqResult },
      { caseNo: 2, caseLabel: '케이스2 — 부담부증여', kind: 'gift', label: '증여세(시가−대출)', result: c2GiftResult },
