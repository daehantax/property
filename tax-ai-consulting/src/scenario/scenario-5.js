...
export function runScenario5(inputs) {
  ...
  return {
    ...
    holdingComputations: [
      ...
      { caseNo: 's', caseLabel: '증여 후 — 배우자(수증 주택)', kind: 'property', label: '재산세', result: spousePropTax },
      { caseNo: 's', caseLabel: '증여 후 — 배우자(수증 주택)', kind: 'aggr', label: '종합부동산세', result: spouseAggrTax },
    ],
    summary: {
