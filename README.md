...
| 세무 판정기 (양도세·취득세 중과, 1세대1주택·재건축·혼인 비과세) | ✅ 구현 완료 | `tax-ai-consulting/src/core/heavy-tax-judge.js`, `single-house-exempt.js`, `redev-exempt.js`, `marriage-exempt.js` |

테스트 242개 (모든 AI 단계는 mock으로 네트워크 없이 검증).
